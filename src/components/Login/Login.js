...
import {TouchableOpacity, Alert, View, StyleSheet, Text, Image, Linking, Platform } from 'react-native';
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.applyScreenButton} onPress={this.onLoginPress}>
