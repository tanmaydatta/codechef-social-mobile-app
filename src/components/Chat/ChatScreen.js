...
import { Platform, StyleSheet, FlatList, RefreshControl, Image, TouchableOpacity, View, Text } from 'react-native'
...
class ChatScreen extends React.Component {
    ...
    convertToArray(realmObject, sender, reciever) {
        var userQuery = 'fromUser == "' + sender + '" OR toUser == "' + sender + '"';
        let copyOfJsonArray = Array.from(realm.objects(realmObject).filtered(userQuery));
        ...
        return (
            ...
            >
                <View style={{ marginRight: 10, marginBottom: 5 }}>
                    <Image style={{ height: 30, width: 30 }} source={require('../../images/send.png')} resizeMode={'center'} />
                </View>
            </Send>
        );
    }
        ...
        return (
            <View style={styles.container}>
                <View style={styles.toolbar}>
                    ...
                    <Text style={styles.toolbarTitle}>{this.props.navigation.getParam('sender')}</Text>
                    <View></View>
                </View>
                <GiftedChat
                    style={{ flex: 1 }}
