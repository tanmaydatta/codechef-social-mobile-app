...
class Profile extends Component {
  ...
  refresh(username) {
    ...
    Network.getUserProfile(username)
      .then(data => {
        console.log(data);
        if (username == "me") {
          realm.write(() => {
            realm.create(
              "MyProfile",
              {
                ...
                allContestRankingGlobal: Number(
                  data.rankings.allContestRanking.global
                ),
                allContestRankingCountry: Number(
                  data.rankings.allContestRanking.country
                ),
                ...
                allSchoolRankingGlobal: Number(
                  data.rankings.allSchoolRanking.global
                ),
                allSchoolRankingCountry: Number(
                  data.rankings.allSchoolRanking.country
                ),
                longSchoolRankingGlobal: Number(
                  data.rankings.longSchoolRanking.global
                ),
                longSchoolRankingCountry: Number(
                  data.rankings.longSchoolRanking.country
                ),
                shortSchoolRankingGlobal: Number(
                  data.rankings.shortSchoolRanking.global
                ),
                shortSchoolRankingCountry: Number(
                  data.rankings.shortSchoolRanking.country
                ),
                ltimeSchoolRankingGlobal: Number(
                  data.rankings.ltimeSchoolRanking.global
                ),
                ltimeSchoolRankingCountry: Number(
                  data.rankings.ltimeSchoolRanking.country
                ),
                ...
                partiallySolvedProblems: Number(
                  data.submissionStats.partiallySolvedProblems
                ),
                solvedProblems: Number(data.submissionStats.solvedProblems),
                attemptedProblems: Number(
                  data.submissionStats.attemptedProblems
                ),
                submittedSolutions: Number(
                  data.submissionStats.submittedSolutions
                ),
                ...
                partiallySolvedSubmissions: Number(
                  data.submissionStats.partiallySolvedSubmissions
                ),
                acceptedSubmissions: Number(
                  data.submissionStats.acceptedSubmissions
                ),
                band: data.band
              },
              true
          ...
          let realmObject = realm.objects("MyProfile");
          this.setState({
            data: this.convertToArray(realmObject),
            animating: false
          });
        } else {
          ...
          <ScrollView contentContainerStyle={styles.scrollViewStyle}>
              ...
              >
                ...
                <View style={{ flex: 1, flexDirection: "row" }}>
                  ...
                  <Flag
                    ...
                    code={this.state.data.country.code}
                  />
                </View>
                <View style={{ flex: 1, flexDirection: "row" }}>
                  <Text
                  ...
                  {this.getStars(this.state.data.band)}
                </View>
              </View>
            </View>
            <View
            ...
            >
              <View style={styles.ratingContainer}>
                <Text style={{ textAlign: "center", fontSize: 12 }}>
                  All Contest:
                  {"\n"}
                  {this.state.data.ratings.allContest}
                </Text>
              </View>
              <View style={styles.ratingContainer}>
                <Text style={{ textAlign: "center", fontSize: 12 }}>
            ...
            <View style={styles.pieChartContainer}>
              <VictoryPie
                ...
                data={[
                  {
                    x: this.state.data.submissionStats.acceptedSubmissions,
                    y: this.state.data.submissionStats.acceptedSubmissions
                  },
                  {
                    x: this.state.data.submissionStats
                      .partiallySolvedSubmissions,
                    y: this.state.data.submissionStats
                      .partiallySolvedSubmissions
                  },
                  {
                    x: this.state.data.submissionStats.wrongSubmissions,
                    y: this.state.data.submissionStats.wrongSubmissions
                  },
                  {
                    x: this.state.data.submissionStats.runTimeError,
                    y: this.state.data.submissionStats.runTimeError
                  },
                  {
                    x: this.state.data.submissionStats.timeLimitExceed,
                    y: this.state.data.submissionStats.timeLimitExceed
                  },
                  {
                    x: this.state.data.submissionStats.compilationError,
                    y: this.state.data.submissionStats.compilationError
                  }
                ]}
              />
            </View>
            <View style={styles.pieChartLegendContainer}>
              <VictoryLegend
                ...
                data={[
                  ...
                  {
                    name: "solutions_partially_accepted",
                    symbol: { fill: "#D8B541" }
                  },
